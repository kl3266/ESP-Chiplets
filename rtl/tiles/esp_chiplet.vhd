...
--  cpuerr <= cpuerr_vec(0);
  ...
  begin
    ...
    begin
      noc1_data_n_in(tile_idx) <= d2d_noc1_data_in_n(tile_idx);
      noc2_data_n_in(tile_idx) <= d2d_noc2_data_in_n(tile_idx);
      noc3_data_n_in(tile_idx) <= d2d_noc3_data_in_n(tile_idx);
      noc4_data_n_in(tile_idx) <= d2d_noc4_data_in_n(tile_idx);
      noc5_data_n_in(tile_idx) <= d2d_noc5_data_in_n(tile_idx);
      noc6_data_n_in(tile_idx) <= d2d_noc6_data_in_n(tile_idx);

      d2d_noc1_data_out_n(tile_idx) <= noc1_data_n_out(tile_idx);
      d2d_noc2_data_out_n(tile_idx) <= noc2_data_n_out(tile_idx);
      d2d_noc3_data_out_n(tile_idx) <= noc3_data_n_out(tile_idx);
      d2d_noc4_data_out_n(tile_idx) <= noc4_data_n_out(tile_idx);
      d2d_noc5_data_out_n(tile_idx) <= noc5_data_n_out(tile_idx);
      d2d_noc6_data_out_n(tile_idx) <= noc6_data_n_out(tile_idx);

      d2d_noc1_data_void_out_n(tile_idx) <= noc1_data_void_out(tile_idx)(0);
      d2d_noc2_data_void_out_n(tile_idx) <= noc2_data_void_out(tile_idx)(0);
      d2d_noc3_data_void_out_n(tile_idx) <= noc3_data_void_out(tile_idx)(0);
      d2d_noc4_data_void_out_n(tile_idx) <= noc4_data_void_out(tile_idx)(0);
      d2d_noc5_data_void_out_n(tile_idx) <= noc5_data_void_out(tile_idx)(0);
      d2d_noc6_data_void_out_n(tile_idx) <= noc6_data_void_out(tile_idx)(0);

      noc1_stop_in(tile_idx)(0) <= d2d_noc1_stop_in_n(tile_idx);
      noc2_stop_in(tile_idx)(0) <= d2d_noc2_stop_in_n(tile_idx);
      noc3_stop_in(tile_idx)(0) <= d2d_noc3_stop_in_n(tile_idx);
      noc4_stop_in(tile_idx)(0) <= d2d_noc4_stop_in_n(tile_idx);
      noc5_stop_in(tile_idx)(0) <= d2d_noc5_stop_in_n(tile_idx);
      noc6_stop_in(tile_idx)(0) <= d2d_noc6_stop_in_n(tile_idx);

      noc1_data_void_in(tile_idx)(0) <= d2d_noc1_data_void_in_n(tile_idx);
      noc2_data_void_in(tile_idx)(0) <= d2d_noc2_data_void_in_n(tile_idx);
      noc3_data_void_in(tile_idx)(0) <= d2d_noc3_data_void_in_n(tile_idx);
      noc4_data_void_in(tile_idx)(0) <= d2d_noc4_data_void_in_n(tile_idx);
      noc5_data_void_in(tile_idx)(0) <= d2d_noc5_data_void_in_n(tile_idx);
      noc6_data_void_in(tile_idx)(0) <= d2d_noc6_data_void_in_n(tile_idx);

      d2d_noc1_stop_out_n(tile_idx) <= noc1_stop_out(tile_idx)(0);
      d2d_noc2_stop_out_n(tile_idx) <= noc2_stop_out(tile_idx)(0);
      d2d_noc3_stop_out_n(tile_idx) <= noc3_stop_out(tile_idx)(0);
      d2d_noc4_stop_out_n(tile_idx) <= noc4_stop_out(tile_idx)(0);
      d2d_noc5_stop_out_n(tile_idx) <= noc5_stop_out(tile_idx)(0);
      d2d_noc6_stop_out_n(tile_idx) <= noc6_stop_out(tile_idx)(0);
  ...
  begin
    ...
    begin
      noc1_data_s_in(internal_tile_idx) <= d2d_noc1_data_in_s(tile_idx);
      noc2_data_s_in(internal_tile_idx) <= d2d_noc2_data_in_s(tile_idx);
      noc3_data_s_in(internal_tile_idx) <= d2d_noc3_data_in_s(tile_idx);
      noc4_data_s_in(internal_tile_idx) <= d2d_noc4_data_in_s(tile_idx);
      noc5_data_s_in(internal_tile_idx) <= d2d_noc5_data_in_s(tile_idx);
      noc6_data_s_in(internal_tile_idx) <= d2d_noc6_data_in_s(tile_idx);

      d2d_noc1_data_out_s(tile_idx) <= noc1_data_s_out(internal_tile_idx);
      d2d_noc2_data_out_s(tile_idx) <= noc2_data_s_out(internal_tile_idx);
      d2d_noc3_data_out_s(tile_idx) <= noc3_data_s_out(internal_tile_idx);
      d2d_noc4_data_out_s(tile_idx) <= noc4_data_s_out(internal_tile_idx);
      d2d_noc5_data_out_s(tile_idx) <= noc5_data_s_out(internal_tile_idx);
      d2d_noc6_data_out_s(tile_idx) <= noc6_data_s_out(internal_tile_idx);

      d2d_noc1_data_void_out_s(tile_idx) <= noc1_data_void_out(internal_tile_idx)(1);
      d2d_noc2_data_void_out_s(tile_idx) <= noc2_data_void_out(internal_tile_idx)(1);
      d2d_noc3_data_void_out_s(tile_idx) <= noc3_data_void_out(internal_tile_idx)(1);
      d2d_noc4_data_void_out_s(tile_idx) <= noc4_data_void_out(internal_tile_idx)(1);
      d2d_noc5_data_void_out_s(tile_idx) <= noc5_data_void_out(internal_tile_idx)(1);
      d2d_noc6_data_void_out_s(tile_idx) <= noc6_data_void_out(internal_tile_idx)(1);

      noc1_stop_in(internal_tile_idx)(1) <= d2d_noc1_stop_in_s(tile_idx);
      noc2_stop_in(internal_tile_idx)(1) <= d2d_noc2_stop_in_s(tile_idx);
      noc3_stop_in(internal_tile_idx)(1) <= d2d_noc3_stop_in_s(tile_idx);
      noc4_stop_in(internal_tile_idx)(1) <= d2d_noc4_stop_in_s(tile_idx);
      noc5_stop_in(internal_tile_idx)(1) <= d2d_noc5_stop_in_s(tile_idx);
      noc6_stop_in(internal_tile_idx)(1) <= d2d_noc6_stop_in_s(tile_idx);

      noc1_data_void_in(internal_tile_idx)(1) <= d2d_noc1_data_void_in_s(tile_idx);
      noc2_data_void_in(internal_tile_idx)(1) <= d2d_noc2_data_void_in_s(tile_idx);
      noc3_data_void_in(internal_tile_idx)(1) <= d2d_noc3_data_void_in_s(tile_idx);
      noc4_data_void_in(internal_tile_idx)(1) <= d2d_noc4_data_void_in_s(tile_idx);
      noc5_data_void_in(internal_tile_idx)(1) <= d2d_noc5_data_void_in_s(tile_idx);
      noc6_data_void_in(internal_tile_idx)(1) <= d2d_noc6_data_void_in_s(tile_idx);

      d2d_noc1_stop_out_s(tile_idx) <= noc1_stop_out(internal_tile_idx)(1);
      d2d_noc2_stop_out_s(tile_idx) <= noc2_stop_out(internal_tile_idx)(1);
      d2d_noc3_stop_out_s(tile_idx) <= noc3_stop_out(internal_tile_idx)(1);
      d2d_noc4_stop_out_s(tile_idx) <= noc4_stop_out(internal_tile_idx)(1);
      d2d_noc5_stop_out_s(tile_idx) <= noc5_stop_out(internal_tile_idx)(1);
      d2d_noc6_stop_out_s(tile_idx) <= noc6_stop_out(internal_tile_idx)(1);
  ...
  begin
    ...
    begin
      noc1_data_w_in(internal_tile_idx) <= d2d_noc1_data_in_w(tile_idx);
      noc2_data_w_in(internal_tile_idx) <= d2d_noc2_data_in_w(tile_idx);
      noc3_data_w_in(internal_tile_idx) <= d2d_noc3_data_in_w(tile_idx);
      noc4_data_w_in(internal_tile_idx) <= d2d_noc4_data_in_w(tile_idx);
      noc5_data_w_in(internal_tile_idx) <= d2d_noc5_data_in_w(tile_idx);
      noc6_data_w_in(internal_tile_idx) <= d2d_noc6_data_in_w(tile_idx);

      d2d_noc1_data_out_w(tile_idx) <= noc1_data_w_out(internal_tile_idx);
      d2d_noc2_data_out_w(tile_idx) <= noc2_data_w_out(internal_tile_idx);
      d2d_noc3_data_out_w(tile_idx) <= noc3_data_w_out(internal_tile_idx);
      d2d_noc4_data_out_w(tile_idx) <= noc4_data_w_out(internal_tile_idx);
      d2d_noc5_data_out_w(tile_idx) <= noc5_data_w_out(internal_tile_idx);
      d2d_noc6_data_out_w(tile_idx) <= noc6_data_w_out(internal_tile_idx);

      d2d_noc1_data_void_out_w(tile_idx) <= noc1_data_void_out(internal_tile_idx)(2);
      d2d_noc2_data_void_out_w(tile_idx) <= noc2_data_void_out(internal_tile_idx)(2);
      d2d_noc3_data_void_out_w(tile_idx) <= noc3_data_void_out(internal_tile_idx)(2);
      d2d_noc4_data_void_out_w(tile_idx) <= noc4_data_void_out(internal_tile_idx)(2);
      d2d_noc5_data_void_out_w(tile_idx) <= noc5_data_void_out(internal_tile_idx)(2);
      d2d_noc6_data_void_out_w(tile_idx) <= noc6_data_void_out(internal_tile_idx)(2);

      noc1_stop_in(internal_tile_idx)(2) <= d2d_noc1_stop_in_w(tile_idx);
      noc2_stop_in(internal_tile_idx)(2) <= d2d_noc2_stop_in_w(tile_idx);
      noc3_stop_in(internal_tile_idx)(2) <= d2d_noc3_stop_in_w(tile_idx);
      noc4_stop_in(internal_tile_idx)(2) <= d2d_noc4_stop_in_w(tile_idx);
      noc5_stop_in(internal_tile_idx)(2) <= d2d_noc5_stop_in_w(tile_idx);
      noc6_stop_in(internal_tile_idx)(2) <= d2d_noc6_stop_in_w(tile_idx);

      noc1_data_void_in(internal_tile_idx)(2) <= d2d_noc1_data_void_in_w(tile_idx);
      noc2_data_void_in(internal_tile_idx)(2) <= d2d_noc2_data_void_in_w(tile_idx);
      noc3_data_void_in(internal_tile_idx)(2) <= d2d_noc3_data_void_in_w(tile_idx);
      noc4_data_void_in(internal_tile_idx)(2) <= d2d_noc4_data_void_in_w(tile_idx);
      noc5_data_void_in(internal_tile_idx)(2) <= d2d_noc5_data_void_in_w(tile_idx);
      noc6_data_void_in(internal_tile_idx)(2) <= d2d_noc6_data_void_in_w(tile_idx);

      d2d_noc1_stop_out_w(tile_idx) <= noc1_stop_out(internal_tile_idx)(2);
      d2d_noc2_stop_out_w(tile_idx) <= noc2_stop_out(internal_tile_idx)(2);
      d2d_noc3_stop_out_w(tile_idx) <= noc3_stop_out(internal_tile_idx)(2);
      d2d_noc4_stop_out_w(tile_idx) <= noc4_stop_out(internal_tile_idx)(2);
      d2d_noc5_stop_out_w(tile_idx) <= noc5_stop_out(internal_tile_idx)(2);
      d2d_noc6_stop_out_w(tile_idx) <= noc6_stop_out(internal_tile_idx)(2);
  ...
  begin
    ...
    begin
      noc1_data_e_in(internal_tile_idx) <= d2d_noc1_data_in_e(tile_idx);
      noc2_data_e_in(internal_tile_idx) <= d2d_noc2_data_in_e(tile_idx);
      noc3_data_e_in(internal_tile_idx) <= d2d_noc3_data_in_e(tile_idx);
      noc4_data_e_in(internal_tile_idx) <= d2d_noc4_data_in_e(tile_idx);
      noc5_data_e_in(internal_tile_idx) <= d2d_noc5_data_in_e(tile_idx);
      noc6_data_e_in(internal_tile_idx) <= d2d_noc6_data_in_e(tile_idx);

      d2d_noc1_data_out_e(tile_idx) <= noc1_data_e_out(internal_tile_idx);
      d2d_noc2_data_out_e(tile_idx) <= noc2_data_e_out(internal_tile_idx);
      d2d_noc3_data_out_e(tile_idx) <= noc3_data_e_out(internal_tile_idx);
      d2d_noc4_data_out_e(tile_idx) <= noc4_data_e_out(internal_tile_idx);
      d2d_noc5_data_out_e(tile_idx) <= noc5_data_e_out(internal_tile_idx);
      d2d_noc6_data_out_e(tile_idx) <= noc6_data_e_out(internal_tile_idx);

      d2d_noc1_data_void_out_e(tile_idx) <= noc1_data_void_out(internal_tile_idx)(3);
      d2d_noc2_data_void_out_e(tile_idx) <= noc2_data_void_out(internal_tile_idx)(3);
      d2d_noc3_data_void_out_e(tile_idx) <= noc3_data_void_out(internal_tile_idx)(3);
      d2d_noc4_data_void_out_e(tile_idx) <= noc4_data_void_out(internal_tile_idx)(3);
      d2d_noc5_data_void_out_e(tile_idx) <= noc5_data_void_out(internal_tile_idx)(3);
      d2d_noc6_data_void_out_e(tile_idx) <= noc6_data_void_out(internal_tile_idx)(3);

      noc1_stop_in(internal_tile_idx)(3) <= d2d_noc1_stop_in_e(tile_idx);
      noc2_stop_in(internal_tile_idx)(3) <= d2d_noc2_stop_in_e(tile_idx);
      noc3_stop_in(internal_tile_idx)(3) <= d2d_noc3_stop_in_e(tile_idx);
      noc4_stop_in(internal_tile_idx)(3) <= d2d_noc4_stop_in_e(tile_idx);
      noc5_stop_in(internal_tile_idx)(3) <= d2d_noc5_stop_in_e(tile_idx);
      noc6_stop_in(internal_tile_idx)(3) <= d2d_noc6_stop_in_e(tile_idx);

      noc1_data_void_in(internal_tile_idx)(3) <= d2d_noc1_data_void_in_e(tile_idx);
      noc2_data_void_in(internal_tile_idx)(3) <= d2d_noc2_data_void_in_e(tile_idx);
      noc3_data_void_in(internal_tile_idx)(3) <= d2d_noc3_data_void_in_e(tile_idx);
      noc4_data_void_in(internal_tile_idx)(3) <= d2d_noc4_data_void_in_e(tile_idx);
      noc5_data_void_in(internal_tile_idx)(3) <= d2d_noc5_data_void_in_e(tile_idx);
      noc6_data_void_in(internal_tile_idx)(3) <= d2d_noc6_data_void_in_e(tile_idx);

      d2d_noc1_stop_out_e(tile_idx) <= noc1_stop_out(internal_tile_idx)(3);
      d2d_noc2_stop_out_e(tile_idx) <= noc2_stop_out(internal_tile_idx)(3);
      d2d_noc3_stop_out_e(tile_idx) <= noc3_stop_out(internal_tile_idx)(3);
      d2d_noc4_stop_out_e(tile_idx) <= noc4_stop_out(internal_tile_idx)(3);
      d2d_noc5_stop_out_e(tile_idx) <= noc5_stop_out(internal_tile_idx)(3);
      d2d_noc6_stop_out_e(tile_idx) <= noc6_stop_out(internal_tile_idx)(3);
