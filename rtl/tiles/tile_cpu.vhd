...
begin
  ...
  leon3_no_cache_coherence : if CFG_L2_ENABLE = 0 generate
    ...
    ahbslv2noc_1 : ahbslv2noc
      generic map (
        ...
        slv_y               => tile_y(io_tile_id(0)),  -- io_tile_id is array...
  ...
  intack2noc_1 : intack2noc
    generic map (
      tech  => CFG_FABTECH,
      irq_y => tile_y(io_tile_id(0)),
      irq_x => tile_x(io_tile_id(0)),
      irq_chip_y => chip_y(io_tile_id(0)),
      irq_chip_x => chip_x(io_tile_id(0)))
    port map (
      rst                    => cleanrstn,
      clk                    => tile_clk,
      cpu_id                 => this_cpu_id,
