...
module bypass_lookahead_router
  ...
  // logic [2:0] arbiter_request_masked [3:0];
...
//      assign arbiter_request_masked[g_i] = (state[g_i] == kHeadFlit) ? transp_final_routing_request[g_i] : 4'b0;
      ...
      // assign arbiter_request_masked[g_i] =
      //     (state[g_i] == kHeadFlit) ? transp_final_routing_request[g_i] : 3'b0;
      ...
      always_ff @(posedge clk) begin
        ...
        end else if (forwarding_head[g_i] && !forwarding_tail[g_i]) begin
