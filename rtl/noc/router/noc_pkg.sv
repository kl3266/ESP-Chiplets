...
package noc;
  ...
  parameter int unsigned chipxMax = 8;
  parameter int unsigned chipyMax = 8;
  // Message Type
  ...
  parameter int unsigned chip_xWidth = $clog2(chipxMax);
  parameter int unsigned chip_yWidth = $clog2(chipyMax);
  ...
  typedef struct packed {
      logic [chip_yWidth-1:0] y;
      logic [chip_xWidth-1:0] x;
  } chip_xy_t;
