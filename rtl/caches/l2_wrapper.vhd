...
-------------------------------------------------------------------------------
  fsm_req : process (req_reg, coherence_req_full,
                     ...
                     req_out_data_word_mask, local_x, local_y, local_chip_x, local_chip_y) is
        ...
        if coherence_req_full = '0' then
          ...
          if req_out_valid = '1' then
            ...
            coherence_req_data_in <= make_header(req_out_data_coh_msg, mem_info,
                                                 ...
                                                 req_out_data_addr, local_x, local_y, local_chip_x, local_chip_y,
                                                 '0', req_id,
                                                 cache_x, cache_y, cache_chip_x, cache_chip_y, req_out_data_word_mask);
...
-------------------------------------------------------------------------------
  fsm_rsp_out : process (rsp_out_reg, coherence_rsp_snd_full,
                         ...
                         rsp_out_data_word_mask, local_x, local_y, local_chip_x, local_chip_y) is
        ...
        if coherence_rsp_snd_full = '0' then
          ...
          if rsp_out_valid = '1' then
            ...
            coherence_rsp_snd_data_in <= make_header(rsp_out_data_coh_msg, mem_info,
                                                     ...
                                                     local_y, local_chip_x, local_chip_y, rsp_out_data_to_req(0),
                                                     rsp_out_data_req_id,
                                                     cache_x, cache_y, cache_chip_x, cache_chip_y, rsp_out_data_word_mask);
            reg.state := send_addr;
...
local_x, local_y, local_chip_x, local_chip_y) is
      ...
      if coherence_fwd_snd_full = '0' then
        ...
        if fwd_out_valid = '1' then
          ...
          coherence_fwd_snd_data_in <= make_dcs_header(fwd_out_data_coh_msg, mem_info,
                                      ...
                                      local_y, local_chip_x, local_chip_y, fwd_out_data_to_req(0),
                                      fwd_out_data_req_id, std_logic_vector(to_unsigned(tile_cache_id(tile_id), NL2_MAX_LOG2)),
                                      cache_x, cache_y, cache_chip_x, cache_chip_y, fwd_out_data_word_mask);
          reg.state := send_addr;
