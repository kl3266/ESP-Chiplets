...
architecture rtl of noc_domain_socket is
  ...
  signal this_local_chip_y : chip_yx;
  signal this_local_chip_x : chip_yx;
  ...
  -- KL NEED TO CHANGE CFG_SIP_TILES_NUM...
  signal tile_id : integer range 0 to CFG_SIP_TILES_NUM - 1;
--  signal chip_id : integer range 0 to CFG_CHIP_NUM - 1;
  ...
  attribute keep of this_local_chip_y            : signal is "true";
  attribute keep of this_local_chip_x            : signal is "true";
...
begin  -- architecture rtl
  ...
  is_tile_io_gen: if is_tile_io = true generate
    tile_id <= io_tile_id(chiplet_index) when tile_config_int(ESP_CSR_TILE_ID_NOC_MSB) = '0' else to_integer(unsigned(tile_config_int(ESP_CSR_TILE_ID_NOC_MSB - 1 downto ESP_CSR_TILE_ID_NOC_LSB)));
    --chip_id <= io_tile_id when tile_config_int(ESP_CSR_TILE_ID_NOC_MSB) = '0' else to_integer(unsigned(tile_config_int(ESP_CSR_TILE_ID_NOC_MSB - 1 downto ESP_CSR_TILE_ID_NOC_LSB))); -- NEED TO IMPL
  end generate;
  is_not_tile_io_gen: if is_tile_io = false generate
    tile_id <= to_integer(unsigned(tile_config_int(ESP_CSR_TILE_ID_NOC_MSB - 1 downto ESP_CSR_TILE_ID_NOC_LSB)));
    --chip_id <= to_integer(unsigned(tile_config_int(ESP_CSR_TILE_ID_NOC_MSB - 1 downto ESP_CSR_TILE_ID_NOC_LSB)));
  end generate;
  ...
  this_local_chip_y <= chip_y(tile_id);
  this_local_chip_x <= chip_x(tile_id);
