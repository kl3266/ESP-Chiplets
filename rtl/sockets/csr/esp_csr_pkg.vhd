...
package esp_csr_pkg is
  ...
  constant NCPU_TILE_MAX : integer := 10;
  constant ESP_CSR_WIDTH : integer := 143 + 2 * 12 * YX_WIDTH + 2 * 10 * CHIP_YX_WIDTH;
  ...
  constant ESP_CSR_CPU_LOC_OVR_4_ADDR : integer range 0 to 31 := 16;
  --constant ESP_CSR_CPU_LOC_OVR_5_ADDR : integer range 0 to 31 := 17;
  --constant ESP_CSR_CPU_LOC_OVR_6_ADDR : integer range 0 to 31 := 18;

  constant ESP_CSR_CPU_LOC_OVR_LSB : integer range 0 to ESP_CSR_WIDTH - 1 := 142;
  constant ESP_CSR_CPU_LOC_OVR_MSB : integer range 0 to ESP_CSR_WIDTH - 1 := 142 + 12 * 2 * YX_WIDTH + 10 * 2 * CHIP_YX_WIDTH;
