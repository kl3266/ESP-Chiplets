...
--pragma translate_on
  ...
  make_packet : process (irqo, cpu_id, local_y, local_x, local_chip_y, local_chip_x)
  ...
  begin  -- process make_packet
    ...
    header_v := (others                                                         => '0');
    header_v := create_header_misc(MISC_NOC_FLIT_SIZE, local_y, local_x, irq_y, irq_x, msg_type, local_chip_y, local_chip_x, irq_chip_y, irq_chip_x, (others => '0'))(MISC_NOC_FLIT_SIZE - 1 downto 0);
