...
entity apb2noc is
  generic (
    ...
    ncpu        : integer := 4;
    apb_slv_cfg : apb_slv_config_vector;  --KL ??
    apb_slv_en  : std_logic_vector(0 to NAPBSLV - 1); -- KL ??
    apb_slv_y   : yx_vec(0 to NAPBSLV - 1);
    apb_slv_x   : yx_vec(0 to NAPBSLV - 1);
    apb_slv_chip_y  : chip_yx_vec(0 to NAPBSLV - 1);
    apb_slv_chip_x  : chip_yx_vec(0 to NAPBSLV - 1));
  port (
    rst      : in  std_ulogic;
    clk      : in  std_ulogic;
    local_y     : in  local_yx;
...
begin  -- rtl
  ...
  make_packet: process (apbi, local_y, local_x, local_chip_y, local_chip_x)
  ...
  begin  -- process make_packet
    ...
    for i in 0 to NAPBSLV - 1 loop
      ...
      if apbi.psel(i) = '1' then
        ...
        header_v := create_header_misc(MISC_NOC_FLIT_SIZE, local_y, local_x, apb_slv_y(i), apb_slv_x(i), msg_type, local_chip_y, local_chip_x, apb_slv_chip_y(i), apb_slv_chip_x(i), (others => '0'))(MISC_NOC_FLIT_SIZE - 1 downto 0);
--pragma translate_off
        --Print("HEADER: ");
