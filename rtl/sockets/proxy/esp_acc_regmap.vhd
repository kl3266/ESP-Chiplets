...
--  constant P2P_WIDTH_MCAST_DESTS : integer range 0 to 31 := 4; KL MOVE TO MCAST REG
  ...
  -- bank(11)       : SRC_OFFSET (offset in bytes from beginning of physical buffer)
  constant SRC_OFFSET_REG : integer range 0 to MAXREGNUM - 1 := 11;

  -- bank(12)       : DST_OFFSET (offset in bytes from beginning of physical buffer)
  constant DST_OFFSET_REG : integer range 0 to MAXREGNUM - 1 := 12;
