...
XMELABOPT += -nomxindr
XMELABOPT += -NAMEMAP_MIXGEN
XMELABOPT += -timescale 1ps/1fs
...
XRUN_UCIE = xrun -linedebug -compile \
						-incdir /home/kevin/columbia_pkg/ \
						-allowredefinition \
						-access r \
						-64bit \
						-sv \
						...
						-timescale 1ps/1fs \
						-work work \
						/home/kevin/columbia_pkg/ucie_esp_defines.vp \
						-F /home/kevin/columbia_pkg/ucie_encrypted.f \
						/home/kevin/columbia_pkg/ucie_wrapper.vp -access +rwc \
						+define+MAINBAND_TEST \
						+define+NO_PHY_SPEEDUPS \
						+define+CLK_TEST
...
ifneq ($(findstring profpga, $(BOARD)),)
	...
	echo $(SPACES)"### Compile UCIE Encrypted Verilog source files ###"; \
	echo $(SPACES)"$(XRUN_UCIE)"; \
	$(XRUN_UCIE) || exit; \
...
xmsim-compile: socketgen check_all_srcs iolink-txt-files xcelium/xmready soft xcelium/xmsim.in
	$(QUIET_MAKE) \
	cd xcelium; \
	rm -f prom.srec ram.srec; \
	ln -s $(SOFT_BUILD)/prom.srec; \
