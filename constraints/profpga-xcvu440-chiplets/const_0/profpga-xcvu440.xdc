...
set c0_d2d_cable_output_delay_min  0.96
# before async fifo change
...
# Diagnostic/calibration pins are asynchronous status indicators.
set_false_path -to [get_ports c0_calib_complete]
set_false_path -to [get_ports c0_diagnostic_led]
set_false_path -to [get_ports c1_calib_complete]
set_false_path -to [get_ports c1_diagnostic_led]
set_false_path -to [get_ports c2_calib_complete]
set_false_path -to [get_ports c2_diagnostic_led]
set_false_path -to [get_ports c3_calib_complete]
set_false_path -to [get_ports c3_diagnostic_led]
