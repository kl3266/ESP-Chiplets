...
set_property UNAVAILABLE_DURING_CALIBRATION TRUE [get_ports {
  c0_cable_io_data[72] c0_cable_io_data[88] c0_cable_io_data[96]
  c0_cable_io_data[132] c0_cable_io_data[134]
  c1_cable_io_data[72] c1_cable_io_data[124] c1_cable_io_data[132]
}]
...
# top_satellite has one DDR controller (c0 MIG); clkm is its user clock.
#-----------------------------------------------------------
#              False Paths                                 -
#-----------------------------------------------------------
