  ...
  with open(template_dir + '/sldacc.vhd', 'r') as ftemplate:
    for tline in ftemplate:
      ...
      for acc in accelerator_list + axi_accelerator_list:
        ...
        f.write("      io_chip_y      : chip_yx;\n")
        f.write("      io_chip_x      : chip_yx;\n")
        ...
        f.write("      cache_chip_y   : chip_yx_vec(0 to 2**NL2_MAX_LOG2 - 1);\n")
        f.write("      cache_chip_x   : chip_yx_vec(0 to 2**NL2_MAX_LOG2 - 1);\n")
        ...
        f.write("      rst               : in  std_ulogic;\n")
        f.write("      clk               : in  std_ulogic;\n")
        f.write("      local_chip_y      : in  chip_yx;\n")
        f.write("      local_chip_x      : in  chip_yx;\n")
        f.write("      local_y           : in  local_yx;\n")
        f.write("      local_x           : in  local_yx;\n")
        f.write("      tile_id           : in  integer range 0 to CFG_SIP_TILES_NUM - 1;\n")
    ...
    for tline in ftemplate:
      if tline.find("-- <<accelerator-wrappers-gen>>") >= 0:
        for acc in accelerator_list + axi_accelerator_list:
          ...
          f.write("        io_chip_y      => io_chip_y,\n")
          f.write("        io_chip_x      => io_chip_x,\n")
          f.write("        io_y           => io_y,\n")
          f.write("        io_x           => io_x,\n")
          f.write("        pindex         => 1,\n")
          ...
          f.write("        cache_chip_y   => cache_chip_y,\n")
          f.write("        cache_chip_x   => cache_chip_x,\n")
          ...
          f.write("        local_chip_y      => this_local_chip_y,\n")
          f.write("        local_chip_x      => this_local_chip_x,\n")
