...
#define esp_get_chip_y(_dev) (CHIP_YX_MASK_CHIP_YX & (ioread32(_dev, CHIP_YX_REG) >> CHIP_YX_SHIFT_CHIP_Y))
#define esp_get_chip_x(_dev) (CHIP_YX_MASK_CHIP_YX & (ioread32(_dev, CHIP_YX_REG) >> CHIP_YX_SHIFT_CHIP_X))
#define esp_p2p_reset(_dev) iowrite32(_dev, P2P_REG, 0)
#define esp_p2p_chip_reset(_dev) iowrite32(_dev, P2P_CHIP_REG, 0)
...
#define esp_p2p_set_chip_y(_dev, _n, _chip_y) iowrite32(_dev, P2P_CHIP_REG, ioread32(_dev, P2P_CHIP_REG) | ((P2P_MASK_SRCS_CHIP_YX & _chip_y) << P2P_SHIFT_SRCS_CHIP_Y(_n)))
#define esp_p2p_set_chip_x(_dev, _n, _chip_x) iowrite32(_dev, P2P_CHIP_REG, ioread32(_dev, P2P_CHIP_REG) | ((P2P_MASK_SRCS_CHIP_YX & _chip_x) << P2P_SHIFT_SRCS_CHIP_X(_n)))
...
#define esp_chip_yx_reg_set_chip_y(_dev, _chip_y, _n, _i) iowrite32(_dev, CHIP_YX_REG + _n, ioread32(_dev, CHIP_YX_REG + _n) | (_chip_y << (_i * 2 * CHIP_YX_WIDTH + CHIP_YX_WIDTH)))
#define esp_chip_yx_reg_set_chip_x(_dev, _chip_x, _n, _i) iowrite32(_dev, CHIP_YX_REG + _n, ioread32(_dev, CHIP_YX_REG + _n) | (_chip_x << (_i * 2 * CHIP_YX_WIDTH)))
