...
architecture rtl of tile_acc is
  ...
  constant io_y                : local_yx                           := tile_y(io_tile_id(0));
  constant io_x                : local_yx                           := tile_x(io_tile_id(0));
  constant io_chip_y           : chip_yx                            := chip_y(io_tile_id(0));
  constant io_chip_x           : chip_yx                            := chip_x(io_tile_id(0));
...
-------------------------------------------------------------------------------
  ...
  dummy_stratus_gen: if this_device = SLD_DUMMY_STRATUS generate
    noc_dummy_stratus_i: noc_dummy_stratus
      generic map (
  ...
  end generate dummy_stratus_gen;
