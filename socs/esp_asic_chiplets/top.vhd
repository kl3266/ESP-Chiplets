...
architecture rtl of top is
  ...
  component fpga_proxy_top is
    generic (
      SIMULATION : boolean;
      JTAG_TRACE : integer range -1 to CFG_SIP_TILES_NUM - 1);
    port (
      reset             : in    std_ulogic;
  ...
  -- Test interface
  signal tdi             : std_logic_vector(0 to CFG_SIP_TILES_NUM - 1);
  signal tdo             : std_logic_vector(0 to CFG_SIP_TILES_NUM - 1);
