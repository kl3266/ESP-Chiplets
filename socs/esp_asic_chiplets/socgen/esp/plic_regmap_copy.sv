...
module plic_regs (
  ...
  input logic [5:0][30:0] ie_i,
  output logic [5:0][30:0] ie_o,
  output logic [5:0] ie_we_o,
  output logic [5:0] ie_re_o,
  input logic [5:0][2:0] threshold_i,
  output logic [5:0][2:0] threshold_o,
  output logic [5:0] threshold_we_o,
  output logic [5:0] threshold_re_o,
  input logic [5:0][4:0] cc_i,
  output logic [5:0][4:0] cc_o,
  output logic [5:0] cc_we_o,
  output logic [5:0] cc_re_o,
  // Bus Interface
  ...
  if (req_i.valid) begin
    if (req_i.write) begin
      unique case(req_i.addr)
        ...
        32'hc002200: begin
          ie_o[4][30:0] = req_i.wdata[30:0];
          ie_we_o[4] = 1'b1;
        end
        32'hc002280: begin
          ie_o[5][30:0] = req_i.wdata[30:0];
          ie_we_o[5] = 1'b1;
        end
        32'hc200000: begin
        ...
        32'hc204004: begin
          cc_o[4][4:0] = req_i.wdata[4:0];
          cc_we_o[4] = 1'b1;
        end
        32'hc205004: begin
          cc_o[5][4:0] = req_i.wdata[4:0];
          cc_we_o[5] = 1'b1;
        end
      ...
      unique case(req_i.addr)
        ...
        32'hc002200: begin
          resp_o.rdata[30:0] = ie_i[4][30:0];
          ie_re_o[4] = 1'b1;
        end
        32'hc002280: begin
          resp_o.rdata[30:0] = ie_i[5][30:0];
          ie_re_o[5] = 1'b1;
        end
        32'hc200000: begin
        ...
        32'hc204004: begin
          resp_o.rdata[4:0] = cc_i[4][4:0];
          cc_re_o[4] = 1'b1;
        end
        32'hc205004: begin
          resp_o.rdata[4:0] = cc_i[5][4:0];
          cc_re_o[5] = 1'b1;
        end       
        default: resp_o.error = 1'b1;
      endcase
