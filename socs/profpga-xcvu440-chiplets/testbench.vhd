...
architecture behav of testbench is
  ...
  -- D2D
  signal b0_b1_cable_data : std_logic_vector(135 downto 0);
  signal b0_b1_cable_clk_p, b0_b1_cable_clk_n : std_logic;
  signal b1_b0_cable_clk_p, b1_b0_cable_clk_n : std_logic;
  ...
  signal uart_cts_b : std_ulogic;
  signal uart_rts_b : std_ulogic;
...
begin
  ...
  d2d_clk_p    <= not d2d_clk_p    after 6.4 ns;
  d2d_clk_n    <= not d2d_clk_n    after 6.4 ns;
  ...
  top_gen : for i in 0 to 1 generate
