...
package esp_global is
  ...
  constant DMA_NOC_WIDTH : integer := 256;
  constant MAX_NOC_WIDTH : integer := 256;
  constant MULTICAST_NOC_EN : integer := 1;
  constant MAX_MCAST_DESTS : integer := 16;
  constant GLOB_WORD_OFFSET_BITS : integer := 2;
  constant GLOB_DMA_WORD_OFFSET_BITS : integer := 3;
  ...
  constant CFG_CACHE_LINE_SIZE  : integer := 256;
  ...
  constant CFG_ETH_IPL : integer := 16#011E#;
  constant CFG_ETH_ENM : integer := 16#A6A7A0#;
  constant CFG_ETH_ENL : integer := 16#F80447#;
  ...
  ------ NoC
  constant WIRES_PER_CONNECTION : integer := 1;
  constant CFG_CHIPLET_ROWS : integer := 2;
  constant CFG_CHIPLET_COLS : integer := 2;
  constant CFG_CHIPLET_NUM : integer := CFG_CHIPLET_ROWS * CFG_CHIPLET_COLS;
  constant CFG_SIP_TILES_NUM : integer := 26;  -- total number of tiles
  ...
  constant CFG_NLLC_COHERENT : integer := 18;  -- NACC + ETH
  ...
  constant CFG_NACC_TILE : integer := 17;
