...
entity dummy_stratus_rtl is
    ...
    port (
      ...
      dma_read_chnl_data         : in  std_logic_vector(255 downto 0);
      dma_write_chnl_valid       : out std_ulogic;
      dma_write_chnl_ready       : in  std_ulogic;
      dma_write_chnl_data        : out std_logic_vector(255 downto 0);
...
begin  -- mapping
  ...
  impl_basic_dma256_gen: if hls_conf = HLSCFG_DUMMY_STRATUS_BASIC_DMA256 generate
    dummy_stratus_basic_dma256_i: dummy_stratus_basic_dma256
    port map(
  ...
  end generate impl_basic_dma256_gen;
