...
input [3:0] inst_1_in1;
wire [3:0] inst_1_in1_w;
reg [3:0] inst_1_in1_r;
...
input [2:0] inst_2_in1;
wire [2:0] inst_2_in1_w;
reg [2:0] inst_2_in1_r;
output [8:0] inst_2_out1;
wire [8:0] inst_2_out1_w;
reg [8:0] inst_2_out1_r;
input [511:0] inst_3_in3;
wire [511:0] inst_3_in3_w;
reg [511:0] inst_3_in3_r;
input [511:0] inst_3_in2;
wire [511:0] inst_3_in2_w;
reg [511:0] inst_3_in2_r;
input [0:0] inst_3_ctrl1;
wire [0:0] inst_3_ctrl1_w;
reg [0:0] inst_3_ctrl1_r;
output [511:0] inst_3_out1;
wire [511:0] inst_3_out1_w;
reg [511:0] inst_3_out1_r;
input clk;
...
dummy_Add_32Sx4U_32S_4 inst_0 (inst_0_in2_w, inst_0_in1_w, inst_0_out1_w);
dummy_Add_16Ux4U_16U_4 inst_1 (inst_1_in2_w, inst_1_in1_w, inst_1_out1_w);
dummy_Add_9Ux3U_9U_4 inst_2 (inst_2_in2_w, inst_2_in1_w, inst_2_out1_w);
dummy_N_MuxB_512_2_1_4 inst_3 (inst_3_in3_w, inst_3_in2_w, inst_3_ctrl1_w, inst_3_out1_w);
