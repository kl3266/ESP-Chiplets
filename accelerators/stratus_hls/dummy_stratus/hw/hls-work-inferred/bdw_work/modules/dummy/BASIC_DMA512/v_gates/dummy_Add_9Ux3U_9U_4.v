...
// Date        : Mon Dec  1 16:12:11 2025
// Host        : haagendazs running 64-bit Red Hat Enterprise Linux release 8.10 (Ootpa)
// Command     : write_verilog -cell inst_2 -force
//               /home/kevin/nov_submission/esp/accelerators/stratus_hls/dummy_stratus/hw/hls-work-inferred/bdw_work/modules/dummy/BASIC_DMA512/v_gates/dummy_Add_9Ux3U_9U_4.v
// Design      : dummy_Add_9Ux3U_9U_4
...
module dummy_Add_9Ux3U_9U_4
  ...
  CARRY4 \out1[0]_INST_0 
       (.CI(\<const0> ),
        ...
        .DI({\<const0> ,in2[2:0]}),
        .O(out1[3:0]),
        .S({in2[3],\out1[0]_INST_0_i_1_n_0 ,\out1[0]_INST_0_i_2_n_0 ,\out1[0]_INST_0_i_3_n_0 }));
  LUT2 #(
    .INIT(4'h6)) 
    \out1[0]_INST_0_i_1 
       (.I0(in2[2]),
